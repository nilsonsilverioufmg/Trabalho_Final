...
#include "../include/BufferCircular.h" // Precisa da definição para criar o objeto
#include "../include/dados.h"          // Precisa da definição dos structs
#include "../include/utils.h"          // Precisa da função gerar_placa_mercosul()
#include "../include/tarefas.h"        // Precisa das declarações das funções das tarefas
#include "../include/mqtt_client_caminhao.h"
...
/**
mosquitto_sub -h 127.0.0.1 -t teste
mosquitto_pub -h 127.0.0.1 -t teste -m "mensagem ok"

nilsonsilverio@Samsung1:~/UFMG/2025_2/ATR/Trabalho_Final/Mina_ATR$ mosquitto_pub -t temperatura -m "46"c
 */